		...
		switch (_p1.ctor) {
			...
			case 'OnInputNewMmeName':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mmeModel: A2(_kosmoskatten$cui$Mme_Panel$onInputNewMmeName, model.mmeModel, _p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SubmitNewMmeForm':
				return {
					...
					_1: _kosmoskatten$cui$Mme_Rest$createNewMme(_p1._0)
				};
			case 'NewMmeCreated':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mmeModel: A2(_kosmoskatten$cui$Mme_Panel$newMmeCreated, model.mmeModel, _p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RestOpFailed':
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							errorMessage: _elm_lang$core$Maybe$Just(
								_kosmoskatten$cui$CsimControlApp$expandError(_p1._0))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _kosmoskatten$cui$CsimControlApp$viewEquipmentSelector = F2(
	function (eq, count) {
		...
		var _p5 = _kosmoskatten$cui$CsimControlApp$equipmentSelectorParams(eq);
		var color = _p5._0;
		var icon = _p5._1;
		var label = _p5._2;
		return A2(
