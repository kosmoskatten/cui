...
var _kosmoskatten$cui$Types$urlRef = A2(
...
var _kosmoskatten$cui$Types$CloseErrorMsg = {ctor: 'CloseErrorMsg'};
...
var _kosmoskatten$cui$Mme_Rest$deleteMmeTask = function (mme) {
	return A3(
...
var _kosmoskatten$cui$Mme_Rest$fetchMmeIpConfigTask = function (urlRef) {
	return A3(
		_lukewestby$elm_http_builder$HttpBuilder$send,
...
var _kosmoskatten$cui$Mme_Rest$createMmeTask = function (name) {
	return A3(
		_lukewestby$elm_http_builder$HttpBuilder$send,
		_lukewestby$elm_http_builder$HttpBuilder$jsonReader(_kosmoskatten$cui$Types$urlRef),
		_lukewestby$elm_http_builder$HttpBuilder$stringReader,
		A2(
			...
			A2(
				...
				_lukewestby$elm_http_builder$HttpBuilder$post('/api/0.1/mme'))));
};
var _kosmoskatten$cui$Mme_Rest$deleteMme = function (mme) {
	return A3(
		...
		A2(
			_elm_lang$core$Task$andThen,
			_kosmoskatten$cui$Mme_Rest$deleteMmeTask(mme),
			function (_p0) {
...
var _kosmoskatten$cui$Mme_Rest$createMme = function (name) {
	return A3(
		...
		A2(
			_elm_lang$core$Task$andThen,
			_kosmoskatten$cui$Mme_Rest$createMmeTask(name),
			function (resp1) {
				return A2(
					_elm_lang$core$Task$andThen,
					_kosmoskatten$cui$Mme_Rest$fetchMmeIpConfigTask(resp1.data),
					function (resp2) {
						return _elm_lang$core$Task$succeed(
			...
			case 'OnInputNewMmeName':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mmeModel: A2(_kosmoskatten$cui$Mme_Panel$onInputNewMmeName, model.mmeModel, _p2._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SubmitNewMmeForm':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mmeModel: _kosmoskatten$cui$Mme_Panel$newMmeFormSubmitted(model.mmeModel)
						}),
					_1: _kosmoskatten$cui$Mme_Rest$createMme(_p2._0)
				};
			case 'NewMmeCreated':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mmeModel: A2(_kosmoskatten$cui$Mme_Panel$newMmeCreated, model.mmeModel, _p2._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'DeleteMme':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _kosmoskatten$cui$Mme_Rest$deleteMme(_p2._0)
				};
			case 'MmeDeleted':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mmeModel: A2(_kosmoskatten$cui$Mme_Panel$mmeDeleted, model.mmeModel, _p2._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RestOpFailed':
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							errorMessage: _elm_lang$core$Maybe$Just(
								_kosmoskatten$cui$CsimControlApp$expandError(_p2._0))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _kosmoskatten$cui$CsimControlApp$viewErrorMessage = function (model) {
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$html$Html_Events$onClick(_kosmoskatten$cui$Types$CloseErrorMsg)
								]),
							_elm_lang$core$Native_List.fromArray(
								[
...
var _kosmoskatten$cui$CsimControlApp$viewEquipmentSelector = F2(
	function (eq, count) {
		...
		var _p6 = _kosmoskatten$cui$CsimControlApp$equipmentSelectorParams(eq);
		var color = _p6._0;
		var icon = _p6._1;
		var label = _p6._2;
		return A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_kosmoskatten$cui$CsimControlApp$viewErrorMessage(model),
				_kosmoskatten$cui$CsimControlApp$viewEquipmentPanel(model)
			]));
};
var _kosmoskatten$cui$CsimControlApp$init = {
	ctor: '_Tuple2',
	_0: {livePanel: _kosmoskatten$cui$Types$UE, errorMessage: _elm_lang$core$Maybe$Nothing, mmeModel: _kosmoskatten$cui$Mme_Panel$initMme},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _kosmoskatten$cui$CsimControlApp$Model = F3(
	function (a, b, c) {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _kosmoskatten$cui$Main$main === 'undefined' ? null : _kosmoskatten$cui$Main$main);
